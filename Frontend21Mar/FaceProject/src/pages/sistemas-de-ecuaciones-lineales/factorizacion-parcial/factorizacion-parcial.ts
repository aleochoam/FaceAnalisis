...
/**
 * Generated class for the FactorizacionParcialPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-factorizacion-parcial',
  templateUrl: 'factorizacion-parcial.html',
})
export class FactorizacionParcialPage {
  private apiUrl  = 'http://165.227.197.6:8080/api/factorizacion_pivoteo/';
